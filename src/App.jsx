...
const firstSoundsGroup = [
  {
    ...
    key: 'Q',
    id: 'Heater-1',
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/HORN1.wav'
  },
  {
    keyCode: 87,
    key: 'W',
    id: 'Heater-2',
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/HORN2.wav'
  },
  {
    keyCode: 69,
    key: 'E',
    id: 'Heater-3',
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/PAD1.wav'
  },
  {
    keyCode: 65,
    key: 'A',
    id: 'Heater-4',
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/PAD2.wav'
  },
  {
    keyCode: 83,
    key: 'S',
    id: 'Clap',
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/BLAST.wav'
  },
  {
    keyCode: 68,
    key: 'D',
    id: 'Open-HH',
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/chord1.wav'
  },
  {
    keyCode: 90,
    key: 'Z',
    id: "Kick-n'-Hat",
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/chord2.wav'
  },
  {
    keyCode: 88,
    key: 'X',
    id: 'Kick',
    url: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/377560/lick.wav'
  },
  {
    keyCode: 67,
    key: 'C',
...
return (
  <button value="test" id={keyCode} className="drum-pad m-2 btn-light" onClick={() => play(key, id)}>
...
return (
  <div id="drum-machine" className="text-center vh-100 bg-dark m-5 p-5">
    {setKeyVolume()}
